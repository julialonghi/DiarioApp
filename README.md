...
Algumas da funcionalidades do aplicativo incluem o uso de Animations, em que, ao criar um novo diário, a imagem dentro do card balança horizontalmente para chamar a atenção do usuário, mostrando que ele foi criado e onde. Outra funcionalidade é o uso da Apple Intelligence para gerar tags a partir do que foi escrito, ou seja, o modelo irá analisar os textos e descreverá os principais tópicos contidos no mesmo.
